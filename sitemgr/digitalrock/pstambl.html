...
<table cols="6" class="profileData">
  <thead>
	...
	<tr class="profileResultHeader profileMarginTop">
		<td colspan="6"><a href="javascript:profile.toggleResults()" title="click to toggle between best results and all results">best results / all results:</a></td>
	</tr>
   </thead>
   <tbody>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		if (!document.location.href.match(/beamer=1/)) {
			setTimeout(function()
			{
				showFooterByNation('div#footer', jQuery('.profileNation').text());
			}, 500);
		}
	});
