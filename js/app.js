...
var RankingApp = /** @class */ (function (_super) {
        ...
        if (_data.question) {
            et2_widget_dialog_1.et2_dialog.show_dialog(function (_button) {
                if (_button == et2_widget_dialog_1.et2_dialog.NO_BUTTON) {
                    ...
                    _this.egw.request('ranking.EGroupware\\Ranking\\Registration\\Ui.ajax_register', [{
                            WetId: _data.WetId,
                            GrpId: _data.GrpId,
                            PerId: _data.PerId,
                            mode: _data.mode,
    ...
    RankingApp.prototype._register_mail = function (_ev, _widget, _node) {
        ...
        var dialog = et2_core_widget_1.et2_createWidget("dialog", {
            // If you use a template, the second parameter will be the value of the template, as if it were submitted.
            callback: function (_button, _values) {
                this.egw.json('ranking.EGroupware\\Ranking\\Registration\\Ui.ajax_mail', [_values, _button, selection, filters], null, null, false, this).sendRequest();
            }.bind(this),
            buttons: buttons,
